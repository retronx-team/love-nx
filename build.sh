...
make -C "$BUILD_DIR/luajit/src" -j$JOBS libluajit.a \
	...
	XCFLAGS="-DLJ_TARGET_CONSOLE=1 -DLUAJIT_DISABLE_JIT -DLUAJIT_DISABLE_FFI -DLUAJIT_USE_SYSMALLOC -DLUAJIT_SECURITY_PRNG=0" \
...
switch_cmake \
	...
	-DOPENAL_INCLUDE_DIR="$PORTLIBS_PREFIX/include" \
